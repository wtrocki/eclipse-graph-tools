...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>egt</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EgtExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.egt")); //$NON-NLS-1$
				Vertex root = EgtFactory.eINSTANCE.createVertex();
