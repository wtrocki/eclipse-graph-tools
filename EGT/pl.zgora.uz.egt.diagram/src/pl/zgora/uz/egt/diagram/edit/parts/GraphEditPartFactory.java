	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case GraphModelEditPart.VISUAL_ID:
				return new GraphModelEditPart(view);

			case VertexEditPart.VISUAL_ID:
				return new VertexEditPart(view);

			case VertexNameEditPart.VISUAL_ID:
				return new VertexNameEditPart(view);

			case SingleEdgeEditPart.VISUAL_ID:
				return new SingleEdgeEditPart(view);

			case SingleEdgeWeightEditPart.VISUAL_ID:
				return new SingleEdgeWeightEditPart(view);

			case DiEdgeEditPart.VISUAL_ID:
				return new DiEdgeEditPart(view);

			case DiEdgeWeightEditPart.VISUAL_ID:
				return new DiEdgeWeightEditPart(view);
