 ...
 * @generated
 */
public class DiEdgeReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DiEdgeReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof DiEdge) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return GraphBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDiEdge_4002(getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return GraphBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDiEdge_4002(getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected DiEdge getLink() {
		return (DiEdge) getElementToEdit();
	}
